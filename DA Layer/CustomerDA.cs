...
namespace Shoe_Store_DB.DA_Layer
{
    internal class CustomerDA
    {
        ...
        public static List<Customer> RetrieveCustomer(int customerId)
        {
            string query = "SELECT customer_id, concat(customer_first_name, ' ', customer_surname, ' ',customer_middle_name) as customer_name, customer_phone_number, customer_email, discount_card_id, discount_card_accumulation FROM customer where customer_id = "+customerId+" order by customer_name;";
            cmd = DBHelper.RunQuery(query);
            List<Customer> customers = new List<Customer>();
            if (cmd != null)
            {
        ...
        public static void CustomerAdd(string firstName, string surname, string middleName, long phoneNumber, string email, long discId, double discAccum)
        {
        ...
        public static void CustomerChange(int id, string firstName, string surname, string middleName, long phoneNumber, string email, long discId, double discAccum)
        {
